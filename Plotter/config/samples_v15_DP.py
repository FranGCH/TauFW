...
def getsampleset(channel,era,**kwargs):
  ...
  from ROOT import getPUWeight,readPUFile
  ...
  if '2022_preEE' in era or '2022_postEE' in era or '2023'in era or '2024' in era or '2025' in era or '2026' in era: # so far same samples and cross sections are used for preEE and postEE, if event numbers are set elsewhere then we don't need to add seperate numbers for both eras
    ...
    if ('2022_preEE' in era or '2022_postEE' in era or '2023'in era or '2024' in era or '2025' in era or '2026' in era) and 'v12' not in era:
      ...
      if '2022_preEE' in era:
        wj_norm = 0.6747
        data_pu_file = indir+"Data_PileUp_2022_preEE.root"
      ...
      expsamples = [ # table of MC samples to be converted to Sample objects
        ...
        ( 'WJ', "WtoTauNu-2Jets",            "Wtau + jets",           22666.*kfactor_wj*wj_norm ), # LO times kfactor
        # ( 'WJ', "WtoTauNu-2Jets_0J",            "W + 0J",           18586.*kfactor_wj ), # LO times kfactor
        ( 'WJ', "WtoMuNu-2Jets",            "Wmu + jets",           22666.*kfactor_wj*wj_norm ), # LO times kfactor
        # ( 'WJ', "WtoMuNu-2Jets_0J",            "W + 0J",           18586.*kfactor_wj ), # LO times kfactor
        ( 'WJ', "WtoENu-2Jets",            "We + jets",           22666.*kfactor_wj*wj_norm ), # LO times kfactor
