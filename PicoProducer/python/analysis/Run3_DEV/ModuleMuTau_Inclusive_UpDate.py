...
class ModuleMuTau_Inclusive_UpDate(ModuleTauPair):
  
  def __init__(self, fname, **kwargs):
    kwargs['channel'] = 'mutau'
    super(ModuleMuTau_Inclusive_UpDate,self).__init__(fname,**kwargs)
  ...
  def beginJob(self):
    ...
    super(ModuleMuTau_Inclusive_UpDate,self).beginJob()
